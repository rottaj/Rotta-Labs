...
d,g))?t.readPixels(a,b,c,d,e,f,g):T(1280)},Fb:function(a,b,c,d){t.renderbufferStorage(a,b,c,d)},Db:function(a,b,c,d,e){t.renderbufferStorageMultisample(a,b,c,d,e)},vb:function(a,b,c){t.samplerParameteri(pc[a],b,c)},ub:function(a,b,c){t.samplerParameteri(pc[a],b,A[c>>2])},X:function(a,b,c,d){t.scissor(a,b,c,d)},W:function(a,b,c,d){for(var e="",f=0;f<b;++f){var g=d?A[d+4*f>>2]:-1;e+=wa(A[c+4*f>>2],0>g?void 0:g)}t.shaderSource(S[a],e)},V:function(a,b,c){t.stencilFunc(a,b,c)},T:function(a,b,c,d){t.stencilFuncSeparate(a,
b,c,d)},S:function(a){t.stencilMask(a)},R:function(a,b){t.stencilMaskSeparate(a,b)},Q:function(a,b,c){t.stencilOp(a,b,c)},P:function(a,b,c,d){t.stencilOpSeparate(a,b,c,d)},O:function(a,b,c,d,e,f,g,k,n){if(2<=m.version)if(t.wd)t.texImage2D(a,b,c,d,e,f,g,k,n);else if(n){var q=Bc(k);t.texImage2D(a,b,c,d,e,f,g,k,q,n>>31-Math.clz32(q.BYTES_PER_ELEMENT))}else t.texImage2D(a,b,c,d,e,f,g,k,null);else t.texImage2D(a,b,c,d,e,f,g,k,n?Cc(k,g,d,e,n):null)},N:function(a,b,c){t.texParameterf(a,b,c)},M:function(a,
b,c){t.texParameterf(a,b,F[c>>2])},L:function(a,b,c){t.texParameteri(a,b,c)},K:function(a,b,c){t.texParameteri(a,b,A[c>>2])},Vb:function(a,b,c,d,e){t.texStorage2D(a,b,c,d,e)},I:function(a,b,c,d,e,f,g,k,n){if(2<=m.version)if(t.wd)t.texSubImage2D(a,b,c,d,e,f,g,k,n);else if(n){var q=Bc(k);t.texSubImage2D(a,b,c,d,e,f,g,k,q,n>>31-Math.clz32(q.BYTES_PER_ELEMENT))}else t.texSubImage2D(a,b,c,d,e,f,g,k,null);else q=null,n&&(q=Cc(k,g,e,f,n)),t.texSubImage2D(a,b,c,d,e,f,g,k,q)},H:function(a,b){t.uniform1f(U(a),
b)},G:function(a,b,c){if(2<=m.version)b&&t.uniform1fv(U(a),F,c>>2,b);else{if(288>=b)for(var d=Dc[b-1],e=0;e<b;++e)d[e]=F[c+4*e>>2];else d=F.subarray(c>>2,c+4*b>>2);t.uniform1fv(U(a),d)}},F:function(a,b){t.uniform1i(U(a),b)},E:function(a,b,c){if(2<=m.version)b&&t.uniform1iv(U(a),A,c>>2,b);else{if(288>=b)for(var d=Ec[b-1],e=0;e<b;++e)d[e]=A[c+4*e>>2];else d=A.subarray(c>>2,c+4*b>>2);t.uniform1iv(U(a),d)}},D:function(a,b,c){t.uniform2f(U(a),b,c)},C:function(a,b,c){if(2<=m.version)b&&t.uniform2fv(U(a),
F,c>>2,2*b);else{if(144>=b)for(var d=Dc[2*b-1],e=0;e<2*b;e+=2)d[e]=F[c+4*e>>2],d[e+1]=F[c+(4*e+4)>>2];else d=F.subarray(c>>2,c+8*b>>2);t.uniform2fv(U(a),d)}},B:function(a,b,c){t.uniform2i(U(a),b,c)},A:function(a,b,c){if(2<=m.version)b&&t.uniform2iv(U(a),A,c>>2,2*b);else{if(144>=b)for(var d=Ec[2*b-1],e=0;e<2*b;e+=2)d[e]=A[c+4*e>>2],d[e+1]=A[c+(4*e+4)>>2];else d=A.subarray(c>>2,c+8*b>>2);t.uniform2iv(U(a),d)}},z:function(a,b,c,d){t.uniform3f(U(a),b,c,d)},Cc:function(a,b,c){if(2<=m.version)b&&t.uniform3fv(U(a),
...
n],r=Ic[a];0===q||10===q?((1===a?oa:pa)(va(r,0)),r.length=0):r.push(q)}e+=k}B[d>>2]=e;return 0},Xa:function(a,b){t.bindFramebuffer(a,lc[b])},v:function(a,b){xc(a,b)},n:Sc,h:Tc,l:Uc,q:Vc,ab:Wc,bb:Xc,p:Yc,j:Zc,b:$c,e:ad,f:bd,w:cd,cb:dd,fb:function(a,b,c,d){return Nc(a,b,c,d)}};
